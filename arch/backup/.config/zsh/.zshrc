...
alias eo="fzf | xargs -r $EDITOR"

# Download the subtitle auto generated by youtube
alias ytsa="youtube-dl --write-auto-sub --skip-download"

# Download the subtitle made by the creator manually
