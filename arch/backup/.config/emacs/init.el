...
(custom-set-variables
 ...
 '(package-selected-packages
   '(switch-window rainbow-mode beacon evil-surround evil-goggles evil-expat evil-visualstar evil-replace-with-register evil-exchange evil-commentary evil-lion evil-collection which-key use-package solarized-theme evil command-log-mode)))
(custom-set-faces
